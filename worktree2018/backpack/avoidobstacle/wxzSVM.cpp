...
Mat wxzSVM::svm(Mat &image, int type)
{
	...
	case 1:
		...
		svm = SVM::load("/home/liyang/worktree2018/avoidobstacle/svmYellow-suc.xml");
		break;
	case 2:
		svm = SVM::load("/home/liyang/worktree2018/avoidobstacle/svmRed-unknown.xml");
		cvtColor(image, image, COLOR_BGR2Lab);
		break;
	case 3:
		svm = SVM::load("/home/liyang/worktree2018/avoidobstacle/svmBlue-suc.xml");
		break;
	}
