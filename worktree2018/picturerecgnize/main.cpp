...
double b1[level1] = { -1.0174, -1.6701, -0.0513 };
double b2[level2] = { 2.3491, -1.5701, 1.2952, -1.0641, 1.6156, 1.3892 };
double b3[level3] = { 2.6482, -0.7334, -1.2996, -0.5098, 0.3117, -0.5176, -1.1489, 1.5719, -1.9329 };
double b4[level4]={-0.2038, 0.2076, 0.3890};
